...
function ReagentData_ClassSpellReagent(item)
     ...
     for class, subtable in pairs(ReagentData['spellreagents']) do
...
function ReagentData_GatheredBy(item)
     ...
     for profession in pairs(ReagentData['gathering']) do
	  if (ReagentData[profession] ~= nil) then
	       for key, value in pairs(ReagentData[profession]) do
		    if (value == item) then 
...
function ReagentData_GetProfessions(item)
     ...
     for profession in pairs(ReagentData['professions']) do
	  if (ReagentData[profession] ~= nil) then
	       for key, value in pairs(ReagentData[profession]) do
		    if (value == item) then 
...
function ReagentData_GetSpellReagents(class)
     ...
     for key, value in pairs(ReagentData['spellreagents']) do
	  if (key == class) then
	       return value;
	  end
     end
...
function ReagentData_IsMonsterDrop(item)
     ...
     for key, value in pairs(ReagentData['monsterdrops']) do
	  if (value == item) then
	       return true;
	  end
     end
...
function ReagentData_IsUsedByProfession(item, profession)
     ...
     for key, value in pairs(ReagentData[ReagentData['reverseprofessions'][profession]]) do
	  if (value == item) then
	       return true;
	  end
     end
...
function ReagentData_IsVendorItem(item)
     ...
     for key, value in pairs(ReagentData['vendor']) do
	  if (value == item) then
	       return true;
	  end
     end
...
local function ReagentData_CreateReverseProfessions()
     ...
     for key, profession in pairs(ReagentData['professions']) do
...
local function ReagentData_CreateReverseGatherSkills()
     ...
     for key, profession in pairs(ReagentData['gathering']) do
	  returnArray[profession] = key;
     end
